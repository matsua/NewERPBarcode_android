...
public class TreeViewList extends ListView {
    private static final int DEFAULT_COLLAPSED_RESOURCE = R.drawable.common_icon_collapsed;
    private static final int DEFAULT_EXPANDED_RESOURCE = R.drawable.common_icon_expanded;
        ...
        if (handleTrackballPress) {
            setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(final AdapterView< ? > parent, final View view, final int position, final long id) {
                    treeAdapter.handleItemClick(view, position, view.getTag());
                }
            });
        } else {
